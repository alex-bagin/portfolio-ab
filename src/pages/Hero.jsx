    ...
    <section className="hero section" id="hero">
      <div className="hero__inner container">
        <div className="hero__scene-wrapper">
          <div className="imgBx">
            <img src="/portfolio-ab/Scripts/static-website-animate.svg" alt="Static Website" />
          </div>
        </div>
        <div className="hero__body">
          <Typed
            strings={[
              ...
              '<span class="intro-1">Hallo!</span> <span class="intro-2"> Mein Name ist </br>Alex Bagin.</br><span class="intro-2">Ich interessiere mich </br> sehr für die Web-Entwicklung. </span>',
